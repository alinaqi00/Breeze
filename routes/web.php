...
// Route::post('Frontend/contact', [ContactusController::class, 'submitForm'])->name('contact.submitForm');
// Route::post('Frontend/contact', [ContactusController::class, 'index']);

Route::match(['get', 'post'], 'Frontend/contact', [ContactusController::class, 'view']);
Route::post('/submit-form', [ContactusController::class, 'submitForm'])->name('contact.submit');
